...
describe('Official MCP Registry Schema Validation Tests', () => {
  test('server.json strictly validates against official 2025-12-11 MCP schema', async () => {
    ...
    assert.strictEqual(serverJson.name, 'io.github.AI-BuildInfra/humancraft-ui');
    assert.strictEqual(serverJson.version, '1.0.0');
  });
});
